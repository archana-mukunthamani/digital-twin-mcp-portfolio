...
CRITICAL REQUIREMENT: This MUST be a Client Component with 'use client' directive at the very top of the file.
...
Directive: MUST have 'use client' at the VERY TOP of the file (line 1)
Styling: Tailwind CSS
Icons: Lucide React
Components: shadcn/ui

CRITICAL: This MUST be a Client Component. Start the file with:
'use client'
...
export default function InterviewLanding({ onStartInterview, onViewAnalytics, interviewCount = 0 }: InterviewLandingProps) {
